...
def prim_generate_maze_cell(a, b, path=False):
    ...
    while selcted_cell_list:
        ...
        #  被选中的设置颜色
        maze_array[selected_x, selected_y] = Path_Number
    ...
    if path:
        ...
        if not path_list:
            ...
            plt.plot(center_x, center_y, 's', c=Road_Color, mfc=Road_Color, lw=1)
...
hh = prim_generate_maze_cell(Row, Column)
