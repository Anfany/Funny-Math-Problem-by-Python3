...
import DLT_DATA as data  # 引入数据
# 模型的类
class MODEL():
    def __init__(self, data, qian, qc, name='前区'):
        '''
...
if __name__ == "__main__":
    ...
    # 开始统计的条数
    start_tongji = 1000 # 这个值超过所有数据的条数，则为预测下一期的结果
    ...
    if '期' in gail:  # 预测情况
        ...
        for ss in range(1, maxcount + 1):
            ...
            plt.xticks([])
            plt.grid()
            plt.savefig(r'C:\Users\GWT9\Desktop\%s_dlt.jpg' % ss)
