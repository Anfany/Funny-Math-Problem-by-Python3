...
# 震荡态
start_life_list, n, m = ([291, 292, 339, 340, 207, 208, 254, 258, 301, 307, 349, 353, 355, 356, 397, 403, 446,
                          450, 495, 496, 215, 263, 311, 216, 264, 312, 169, 361, 123, 171, 363, 411, 277, 278,
                          229, 230], 32, 48)
...
def plot_life_game(data, figname):
    ...
    plt.figtext(0.6, 0.43, '滑翔机', weight='bold', color='#3f48cc', size='large', rotation=-60, **alignment)
    plt.figtext(0.45, 0.78, '高斯帕机枪', weight='bold', color='#3f48cc', size='large', **alignment)
...
namelist = ['%s.jpg' % dd for dd in range(70, 100)]
...
def create_gif(image_list, gif_name=r'C:\Users\GWT9\Desktop\anfany.gif'):
    ...
    imageio.mimsave(gif_name, frames, 'GIF', duration=0.1)  # duration控制动态图中每张图片的显示时间
